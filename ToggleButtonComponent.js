...
class ToggleButtonComponent extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      leftColor: value ? '#293133' : '#fff',
      rightColor: value ? '#fff' : '#293133',
    };
  ...
  componentDidUpdate(prevProps) {
    ...
    if (prevProps !== currentProps) {
      ...
      Animated.timing(this.offsetX, {
        ...
        this.setState({
          leftColor: currentProps.value ? '#293133' : '#fff',
          rightColor: currentProps.value ? '#fff' : '#293133',
        });
      });
    }
  }
  ...
  onToggleLongPress = () => {
    const { value, changeToggleStateOnLongPress, onToggleLongPress } = this.props;
      ...
      <View style={[styles.container]}>
        ...
        >
          <Text
            style={{
              position: 'absolute',
              left: this.dimensions.sliderWidth / 4,
              color: leftColor,
            }}
          >
            {leftText}
          ...
          <Text
            style={{
              position: 'absolute',
              right: this.dimensions.sliderWidth / 4,
              color: rightColor,
            }}
          >
            {rightText}
